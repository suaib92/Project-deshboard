...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="flex flex-col bg-white p-6 rounded-lg shadow-lg space-y-4 hover:shadow-xl transition duration-300 ease-in-out">
      ...
      <Link to={`/projects/${project._id}`} className="text-blue-600 font-medium hover:underline transition duration-200 ease-in-out">
        View Project
      </Link>
    </div>
  );
...
export default ProjectCard;  // Ensure this is a default export
